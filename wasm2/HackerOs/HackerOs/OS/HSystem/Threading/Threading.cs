...
namespace HackerOs.OS.HSystem.Threading
{
    /// <summary>
    ...
    public sealed class Timer : IDisposable
    {
        ...
        {
            _timer = new HSystem.Threading.Timer(callback, state, dueTime, period);
        }
    ...
    public class CancellationTokenSource : IDisposable
    {
        ...
        {
            _source = new HSystem.Threading.CancellationTokenSource();
        }

        public CancellationTokenSource(TimeSpan delay)
        {
            _source = new HSystem.Threading.CancellationTokenSource(delay);
        }
    ...
    /// </summary>
    public class Lazy<T> : HSystem.Lazy<T>
    {
        public Lazy() : base() { }
    ...
    /// </summary>
    public class ConcurrentDictionary<TKey, TValue> : System.Collections.Generic.IDictionary<TKey, TValue>
        where TKey : notnull
    {
        ...
        public void CopyTo(System.Collections.Generic.KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            lock (_lock)
            {
                ...
                {
                    array[index++] = new System.Collections.Generic.KeyValuePair<TKey, TValue>(kvp.Key, kvp.Value);
                }
            }
        }        
        ...
        {
            List<System.Collections.Generic.KeyValuePair<TKey, TValue>> items;
            lock (_lock)
            {
                items = _dictionary.Select(kvp => kvp).ToList();
            }
